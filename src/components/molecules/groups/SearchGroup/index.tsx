  ...
  return (
    <div className="m-4 flex flex-col items-center">
      <InputCustomize
        ...
        className="h-10 w-full rounded-2xl bg-gray-200 hover:bg-gray-200 "
        value={searchGroup}
      ...
      {searchResults.length > 0 && (
        <List
          className="absolute z-10 mt-10 max-h-96 w-[180px] overflow-y-auto overflow-x-hidden rounded-xl bg-gray-100  shadow-lg md:w-[352px]"
          bordered
          dataSource={searchResults}
          renderItem={(item: any) => (
            <List.Item className="-mx-4 cursor-pointer rounded-xl hover:bg-gray-200" onClick={() => handleClick(item)}>
